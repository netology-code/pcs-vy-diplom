...
Необходимо реализовать алгоритм, который по порядковому номеру вернет число ряда Фибоначчи.
...
Добавим вручную первые 2 элемента, далее в цикле будем добавлять элемент, являющийся суммой 2 предыдущих, пока не дойдем до нужного номера.
